...
// Ex.
var testName = "user"; // The compiler infers the type string for the variable testName.
var testNumber = 20; // The compiler infers the type number for the variable testNumber.
